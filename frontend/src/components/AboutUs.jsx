        ...
        <div className="about__content">
          <div className="about__content__left">
            <p className="about__content__left__description">
              ...
              guitars, we aim to be your ultimate destination.Our team consists
              of experienced musicians who are always ready to share their
              knowledge and help you find the perfect instrument to match your
              style and needs. We pride ourselves on offering personalized
              service, quality products, and a welcoming atmosphere where every
              customer feels like a rockstar.Join us at Guitar Heaven, where
              every strum tells a story and every note finds its home.
            </p>
